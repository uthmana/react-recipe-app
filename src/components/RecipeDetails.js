...
//     this.state = {
//   recipe: recipe,
//   url: `https://www.food2fork.com/api/get?key=8f6ecefaab2f36f6d521a015f101a5d6&rId=${this.props.id}`
// };
//
// }
//
...
async componentDidMount(){
  ...
  const url = `https://www.food2fork.com/api/get?key=8f6ecefaab2f36f6d521a015f101a5d6&rId=${id}`;
  try{
...
const {handleIndex} = this.props
  ...
  <h6 className="text-warning text-capitalize text-slanted">provided by {publisher}</h6>
   ...
   <a href={source_url} className="btn btn-success mt-2 mx-2 text-capitalize" target="_blank" rel="noopener noreferrer">Recipe URL</a>
   <ul className="list-group mt-4">
    <h2 className="mt-3 mb-4">Ingredrients</h2>
    {
